    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zone', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.zone')),
            ],
        ),
        migrations.CreateModel(
            name='Depot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depot', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.depot')),
                ('state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.state')),
                ('zone', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.zone')),
            ],
        ),
